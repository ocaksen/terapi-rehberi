...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/trabzon`,                 lastModified: new Date(), changeFrequency: "weekly",  priority: 0.9 },
    { url: `${BASE}/blog/trabzon-psikolog-nasil-secilir`,     lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/blog/trabzon-psikolog-fiyatlari-2026`,    lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },

    ...
    <article className="bg-white rounded-2xl border border-cream-200 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group">
      <div className="flex gap-0">
        ...
        <div className="flex-1 p-4 flex flex-col gap-2.5 min-w-0">
          ...
          {/* Alt: fiyat + butonlar */}
          <div className="flex items-center justify-between mt-auto pt-2 border-t border-cream-100 gap-2">
            <div>
            ...
            <div className="flex gap-1.5">
              <a
                ...
                className="flex items-center gap-1 bg-brand-600 hover:bg-brand-700 text-white text-xs font-semibold px-3 py-2 rounded-xl transition-colors min-h-[44px]"
              >
              ...
              <Link
                href={href}
                className="flex items-center gap-1 bg-brand-600 hover:bg-brand-700 text-white text-xs font-semibold px-3 py-2 rounded-xl transition-colors min-h-[44px] min-w-[44px] justify-center"
              >
                Profil
